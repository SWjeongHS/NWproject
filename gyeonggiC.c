...
int main(int argc, char *argv[]){
    ...
    const char localName[] = "G";
    send(sock,localName,strlen(localName),0);
    FILE * file13 = fopen("13gyeongi.csv","rt");
    ...
    FILE * file14 = fopen("14gyeongi.csv","rt");
    char line2 [1024];
    ...
    FILE * file22 = fopen("22gyeonggi.csv","rt");
    char line3 [1024];
